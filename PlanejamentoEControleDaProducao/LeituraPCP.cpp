...
void LeituraPCP::LerMensagem() {
	...
	mensagem << TIPO 
			 ...
			 << "#" << GerarOperacao() 
		     << "#" << GerarHora()
			 << "#" << FuncoesAuxiliares::Formatar(FuncoesAuxiliares::ValorAleatorio(99999), 5);
...
std::string LeituraPCP::GerarOperacao() {
	...
	ss << charAleatorio() 
	   << charAleatorio() 
	   << charAleatorio() << "-" 
	   << FuncoesAuxiliares::Formatar(FuncoesAuxiliares::ValorAleatorio(9999), 4);
...
std::string LeituraPCP::GerarHora() {
	...
	minuto = rand() % 60;
	segundo = rand() % 60;
	ss << FuncoesAuxiliares::Formatar(hora, 2) << ":" 
	   << FuncoesAuxiliares::Formatar(minuto, 2) << ":" 
	   << FuncoesAuxiliares::Formatar(segundo, 2);
